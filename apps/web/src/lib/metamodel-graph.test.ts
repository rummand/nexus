...
const node = (name: string, instances = 1) => ({ id: name, name, description: "", color: "#000", parentId: null, instances, fields: [], presence: "declared" as const, framework: "", layerId: null });
  ...
  relationTypes: [
    {
      ...
      presence: "declared", framework: "", layerId: null,
    },
    {
      ...
      presence: "undeclared", framework: "", layerId: null,
    },
    {
      ...
      presence: "unused", framework: "", layerId: null,
    },
  ],
...
describe("typeGraph", () => {
  ...
  it("adds a node for a type named only by a rule, so no edge dangles", () => {
    const withGhost: MetaModel = {
      ...
      relationTypes: [{ id: "x", name: "hosts", description: "", instances: 0, rules: [{ id: "rx", fromType: "Application", toType: "Ghost", cardinality: "many-to-many" }], observedPairs: [], presence: "unused", framework: "", layerId: null }],
    };
