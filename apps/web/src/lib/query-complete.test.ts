...
const vocab: GraphSnapshot = {
  entities: [
    { id: "1", kind: "Application", name: "SAP S/4", description: "", attributes: { lifecycle: "active", owner: "Corporate IT" }, parentId: null, source: "", updatedAt: "", boardCount: 0, relationCount: 0, boards: [] },
    { id: "2", kind: "Application", name: "CRM Cloud", description: "", attributes: { lifecycle: "end of life" }, parentId: null, source: "", updatedAt: "", boardCount: 0, relationCount: 0, boards: [] },
    { id: "3", kind: "Interface", name: "Customer API", description: "", attributes: {}, parentId: null, source: "", updatedAt: "", boardCount: 0, relationCount: 0, boards: [] },
  ],
  kinds: [
