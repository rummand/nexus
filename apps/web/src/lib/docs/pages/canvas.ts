...
export const BOARD_AGENTS: DocPage = {
  ...
  blocks: [
    ...
    { kind: "prose", text: "**Ask a follow-up.** The exchange stays on screen, and the next question carries the ones before it — so \u201cand which of those are customer-facing?\u201d is a question rather than a fragment. Press the arrow at the top of the block to start again." },
    { kind: "prose", text: "**Keep what is worth keeping.** *Keep as a comment* turns the exchange into a comment on the board (or on the object, if that is all you had selected): the questions, the answers, and the words on the objects each answer rested on. Until now a good answer lasted exactly as long as your selection did." },
    { kind: "note", tone: "why", title: "Why a comment and not a note", text: "A note is a thing on the drawing; a comment is somebody talking about the drawing, and that is what this is. It also means the answer arrives where colleagues already look, keeps who kept it and when, and can be settled when it stops mattering \u2014 without adding an object nobody drew." },
    { kind: "note", tone: "warning", text: "The kept comment says plainly that a model wrote the prose. Please leave that in if you edit it: an agent\u2019s answer read as a colleague\u2019s is the worst thing this feature could do." },
