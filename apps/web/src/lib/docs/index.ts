...
import { AGENT, DESCRIBED, EXPLORER, FACT_SHEET, FLEET, GRAPH, HEALTH, HIERARCHY, INVENTORY, META_MODEL, UNATTENDED, WHAT_CHANGED } from "./pages/model";
...
export const SECTIONS: DocSection[] = [
  ...
  { title: "The model", pages: [GRAPH, INVENTORY, FACT_SHEET, EXPLORER, HIERARCHY, META_MODEL, HEALTH, WHAT_CHANGED] },
