...
import { BookOpen, Bot, Boxes, Clock3, Cpu, Database, DownloadCloud, GitBranch, History, Home, Inbox, LifeBuoy, LogOut, Plug, Plus, Star, UserCog, Users, Waypoints, NotebookText } from "lucide-react";
